...
import './PickInput.css'; // make sure your styles are scoped correctly
...
export default function PickInput() {
  ...
  const handleLinkChange = (e) => {
    ...
    if (input.includes('google.com/maps')) {
      ...
      const apiKey = 'AIzaSyDtq8AJBCIBvaksW7n2CfV3BIH-46I5qWQ';
  ...
  return (
    <div className="phone-frame">
      ...
      <label className="input-label">Link to website (Optional)</label>
      <input className="text-input" type="text" placeholder="https://..." />

      <label className="input-label">Link to Google (Optional)</label>
      <input
